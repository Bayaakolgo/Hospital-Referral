...
urlpatterns +=[
    ...
    path('patient-referral', views.patient_referral_view,name='patient-referral'),
    path('patient-view-referral',views.patient_view_referral_view,name='patient-view-referral'),
